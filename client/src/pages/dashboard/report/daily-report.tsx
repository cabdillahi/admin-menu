...
import { useGetDailyReportQuery } from "@/services/reports/report-api";
...
export default function DailyReport() {
  ...
  const { data, isLoading, isError } = useGetDailyReportQuery();
    ...
    return (
      <div className="container mx-auto space-y-6 p-4 md:p-6 lg:p-8">
        <Alert variant="destructive">
          ...
          <AlertDescription>
            Failed to load daily report. Please try again later.
          </AlertDescription>
        </Alert>
      </div>
    );
  ...
  return (
    <div className="container mx-auto space-y-6 p-4 md:p-6 lg:p-8">
      ...
      <div className="hidden print:block">
        <h1 className="mb-4 text-3xl font-bold">Daily Report</h1>
        {dateRange?.from && (
