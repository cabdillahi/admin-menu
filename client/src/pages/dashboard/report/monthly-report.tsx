...
import { useGetMonthlyReportQuery } from "@/services/reports/report-api";
...
export default function MonthlyReportPage() {
  ...
  const { data, isLoading, isError } = useGetMonthlyReportQuery();
    ...
    return (
      <div className="container mx-auto space-y-6 p-4 md:p-6 lg:p-8">
        <Alert variant="destructive">
          ...
          <AlertDescription>
            Failed to load monthly report. Please try again later.
          </AlertDescription>
        </Alert>
      </div>
    );
